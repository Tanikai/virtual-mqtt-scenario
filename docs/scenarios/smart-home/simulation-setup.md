...
!!! important
    The code examples in this documentation can contain a plus symbol (+) in
    some lines. When you click on the (+) symbol, an annotation can be seen.

The most basic MQTT scenario without any devices can be seen here:
